...
<a name="nosot1"></a>
    ...
    <h2>Pantalon Largo</h2>
        <div class="servicios">
        <?php
        $response = json_decode(file_get_contents('http://suenointimo.univallebuga.host/SuenoIntimo-WEB/api/productos/api-productos.php?categoria=PantalonLargo'), true);
